...
<div class="col-sm-5">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
         ...
         <input name="nama" placeholder="Nama Sekolah" value="<?= $sekolah->nama ?>" class="form-control" />
      ...
      <div class="form-group">
         ...
         <select name="jenis" class="form-control">
            <option value=""><?= $sekolah->jenis ?></option>
      ...
      <div class="form-group">
         ...
         <input name="kepala_sekolah" placeholder="Nama Kepala Sekolah" value="<?= $sekolah->kepala_sekolah ?>" class="form-control" />
